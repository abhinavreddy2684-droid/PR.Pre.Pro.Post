...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      <button type="button" onClick={handleGoogle} className="group flex w-full items-center justify-center gap-3 rounded-full border border-white/[0.10] bg-transparent px-5 py-3.5 text-sm font-medium text-white backdrop-blur-md backdrop-saturate-75 transition duration-300 hover:border-white/20 hover:bg-white/[0.025]">
        <span className="grid h-5 w-5 place-items-center rounded-full bg-white text-[11px] font-black text-black transition group-hover:scale-105">G</span>
