      ...
      <div className="min-h-screen bg-[#090909] text-white">
        ...
        <main className="pt-40 pb-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link to="/talent?craft=Playback%20Singing" className="inline-flex mt-8 items-center gap-2 text-amber-400">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="mt-10 grid lg:grid-cols-[0.85fr_1.15fr] gap-12 items-start">
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 aspect-[4/5] bg-neutral-900">
              ...
              <span className="absolute left-5 bottom-5 px-3 py-1.5 rounded-full bg-amber-400 text-black text-xs font-semibold uppercase tracking-[0.16em]">
                {talent.availability}
              </span>
            </div>
            ...
            <div className="pt-2">
              ...
              <button className="mt-10 inline-flex items-center gap-3 rounded-full bg-amber-400 px-8 py-4 font-semibold text-black hover:bg-amber-300 transition-colors">
                Hire Talent
                <ArrowRight size={18} />
              </button>
            </div>
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 md:p-10">
              ...
              <div className="mt-8 grid md:grid-cols-2 gap-5">
                {["Featured performance", "Studio session", "Live performance", "Film soundtrack"].map((item) => (
                  <button key={item} className="group relative aspect-video overflow-hidden rounded-2xl border border-white/10 bg-neutral-900 text-left">
